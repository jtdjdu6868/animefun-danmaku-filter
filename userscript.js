...
(function() {
    ...
    const config_properties = ["enable_filter_szh", "enable_filter_custom"];
    const config = {};
    for(let key of config_properties)
    {
        Object.defineProperty(config, key, {
            ...
            get: function() {
                return (localStorage.getItem(key) || (localStorage.setItem(key, "enable"), "enable")) == "enable";
            }
        });
    }
